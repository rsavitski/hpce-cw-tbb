...
FOURIER_IMPLEMENTATION_OBJS += src/rs5010/direct_fourier_transform_parfor.o src/rs5010/fast_fourier_transform_taskgroup.o src/rs5010/fast_fourier_transform_parfor.o src/rs5010/fast_fourier_transform_combined.o src/rs5010/fast_fourier_transform_opt.o
