...
class direct_fourier_transform_parfor : public fourier_transform
{
 protected:
                             ...
                             std::complex<double> *pOut, size_t sOut) const
  {
    ...
    tbb::parallel_for(size_t(0), n, loop_body);
  }

  virtual void backwards_impl(size_t n, const std::complex<double> &wn,
                              const std::complex<double> *pIn, size_t sIn,
                              std::complex<double> *pOut, size_t sOut) const
  {
    assert(n > 0);
 ...
 public:
  ...
  {
    return "hpce.rs5010.direct_fourier_transform_parfor";
  }

  virtual bool is_quadratic() const { return true; }
};
